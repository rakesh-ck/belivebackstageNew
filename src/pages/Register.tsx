...
import { Music, AlertCircle, Loader2, Check } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Create profile</h2>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        >
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="role" className="block text-sm font-medium text-gray-700 mb-3">I am a...</label>
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <span className="text-sm font-bold uppercase tracking-wide">Artist</span>
                  {role === 'artist' && <Check size={16} className="mt-1" />}
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  {role === 'label' && <Check size={16} className="mt-1" />}
                </button>
              </div>
            </div>

            <div>
              <label htmlFor="name" className="block text-sm font-medium text-gray-700">{role === 'artist' ? 'Artist Name' : 'Label Name'}</label>
              <div className="mt-1">
                <input
                  id="name"
                  name="name"
            ...
            <div className="text-xs text-gray-500">
              By registering, you agree to our <Link to="#" className="text-[#1976D2] hover:underline">Terms of Service</Link> and <Link to="#" className="text-[#1976D2] hover:underline">Privacy Policy</Link>.
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/login" className="font-medium text-[#1976D2] hover:text-blue-500">
                Sign in
              </Link>
            </p>
          </div>
